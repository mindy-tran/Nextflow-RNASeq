...
The gene-level counts give a general quantification of gene expression rather than counting individual transcripts. It's the total number of reads mapped to a gene where the reads align to any of a gene's exons.
...
I do expect some nmapped reads, but 10% unmapped could imply contamination, sequencing errors, or issues with the reference genome. Since I can filter these reads out, I am concerned but not  immensely concerened.
